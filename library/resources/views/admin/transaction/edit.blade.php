                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" id="tanggal" readonly class="form-control" name="date_start" value="{{ $transaction->date_start }}">          
                                        </div>
                                        <div class="col-md-6">
                                            <label for="date_start">Date end</label>
                                            <input type="hide" id="tanggal" readonly class="form-control" name="date_end" value="{{ $transaction->date_end }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Book</label>
                                    <select class="select2"  multiple="multiple" data-placeholder="" style="width: 100%;" name="book_id[]" readonly>
                                        @foreach ($trx_books as $book)
