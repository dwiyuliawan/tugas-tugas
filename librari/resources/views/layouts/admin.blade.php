...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('catalogs')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023-2024 <a href="http://dwiyuliawan.github.io/portofolio">Dwi Yuliawan</a>.</strong>
    All rights reserved.
